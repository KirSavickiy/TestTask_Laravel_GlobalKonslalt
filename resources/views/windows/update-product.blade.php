    ...
    <div class="bg-white rounded-lg shadow-lg w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-6">
        ...
        <form id="updateForm" class="mt-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="recordName" value="{{$product->name}}" required
                    class="mt-1 p-2 w-full border border-gray-300 rounded-md focus:outline-none focus:border-blue-500">
                <span id="name_update_error" class="error text-red-500 text-sm mt-1 block"></span>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center mt-2">
                    <input type="radio" id="available" name="status" value="available"
                        class="mr-2 text-blue-500 focus:ring-blue-500" {{$product->status === 'available' ? 'checked' : ''}}>
                    <label for="available" class="mr-8 text-gray-700">Доступен</label>

                    <input type="radio" id="unavailable" name="status" value="unavailable"
                        class="mr-2 text-blue-500 focus:ring-blue-500" {{$product->status === 'unavailable' ? 'checked' : ''}}>
                    <label for="unavailable" class="text-gray-700">Не доступен</label>
                </div>
                <span id="status_update_error" class="error text-red-500 text-sm mt-1 block"></span>
            </div>
